...
! function (t) {
    ...
    o(), t(window).scroll(o), t(function () {
...
/*
$.getJSON("./ressources/skills.json", function (json) {
    console.log("JSON Data: " + json);
});
var myjson = require("./ressources/skills.json");
*/
function loadJSON(callback) {
    var xobj = new XMLHttpRequest();
    xobj.overrideMimeType("application/json");
    xobj.open('GET', './ressources/skills.json', true);
